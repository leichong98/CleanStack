...
static const SanitizerMask SupportsCoverage =
    ...
    SanitizerKind::SafeStack | SanitizerKind::CleanStack | SanitizerKind::ShadowCallStack;
...
SanitizerArgs::SanitizerArgs(const ToolChain &TC,
  ...
  std::pair<SanitizerMask, SanitizerMask> IncompatibleGroups[] = {
      ...
      std::make_pair(SanitizerKind::CleanStack, // 新增 CleanStack 不兼容项
                   SanitizerKind::Address | SanitizerKind::HWAddress |
                       SanitizerKind::Leak | SanitizerKind::Thread |
                       SanitizerKind::Memory | SanitizerKind::KernelAddress |
                       SanitizerKind::Scudo | SanitizerKind::SafeStack |
                       SanitizerKind::KernelHWAddress |
                       SanitizerKind::KernelMemory | SanitizerKind::MemTag)
  };
  ...
  if (AllAddedKinds & SanitizerKind::CleanStack) {
    // CleanStack runtime is built into the system on Fuchsia.
    CleanStackRuntime = !TC.getTriple().isOSFuchsia();
  }
