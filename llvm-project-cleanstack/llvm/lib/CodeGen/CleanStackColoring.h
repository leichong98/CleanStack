//===- CleanStackColoring.h - CleanStack frame coloring ----------*- C++ -*--===//
//
...
#ifndef LLVM_LIB_CODEGEN_CLEANSTACKCOLORING_H
#define LLVM_LIB_CODEGEN_CLEANSTACKCOLORING_H
...
#endif // LLVM_LIB_CODEGEN_CLEANSTACKCOLORING_H