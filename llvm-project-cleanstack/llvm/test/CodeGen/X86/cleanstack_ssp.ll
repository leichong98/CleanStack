; Test codegen pipeline for CleanStack + StackProtector combination.
...
define void @_Z1fv() cleanstack sspreq {
entry:
...
; LINUX-X64-DAG: movq __cleanstack_unclean_stack_ptr@GOTTPOFF(%rip), %[[A:.*]]
...
; LINUX-I386-DAG: movl __cleanstack_unclean_stack_ptr@INDNTPOFF, %[[A:.*]]
