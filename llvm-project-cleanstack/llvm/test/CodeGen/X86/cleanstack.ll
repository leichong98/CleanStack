...
; RUN: llc -mtriple=i386-linux -cleanstack-use-pointer-address < %s -o - | FileCheck --check-prefix=LINUX-I386-PA %s
...
; LINUX-X64: movq __cleanstack_unclean_stack_ptr@GOTTPOFF(%rip), %[[A:.*]]
; LINUX-X64: movq %fs:(%[[A]]), %[[B:.*]]
; LINUX-X64: leaq -16(%[[B]]), %[[C:.*]]
; LINUX-X64: movq %[[C]], %fs:(%[[A]])

; LINUX-I386: movl __cleanstack_unclean_stack_ptr@INDNTPOFF, %[[A:.*]]
...
; LINUX-I386-PA: calll __cleanstack_pointer_address
