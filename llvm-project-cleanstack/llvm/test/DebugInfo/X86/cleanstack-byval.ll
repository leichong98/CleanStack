...
; CleanStack for unclean byval arguments.
; RUN: llc -mtriple=x86_64-unknown-unknown -stop-after finalize-isel %s -o - | FileCheck %s

; This was built by compiling the following source with CleanStack and
...
@__cleanstack_unclean_stack_ptr = external thread_local(initialexec) global i8*

; Function Attrs: norecurse nounwind readonly cleanstack uwtable
define i32 @_Z1f1Sm(%struct.S* byval nocapture readonly align 8 %zzz, i64 %len) #0 !dbg !12 {
entry:
  %unclean_stack_ptr = load i8*, i8** @__cleanstack_unclean_stack_ptr, !dbg !22
  %unclean_stack_static_top = getelementptr i8, i8* %unclean_stack_ptr, i32 -400, !dbg !22
  store i8* %unclean_stack_static_top, i8** @__cleanstack_unclean_stack_ptr, !dbg !22
; !17 describes "zzz"
  call void @llvm.dbg.declare(metadata i8* %unclean_stack_ptr, metadata !17, metadata !23), !dbg !22
  %0 = getelementptr i8, i8* %unclean_stack_ptr, i32 -400, !dbg !22
  %zzz.unclean-byval = bitcast i8* %0 to %struct.S*, !dbg !22
  ...
  %arrayidx = getelementptr inbounds %struct.S, %struct.S* %zzz.unclean-byval, i64 0, i32 0, i64 %len, !dbg !26
  %2 = load i32, i32* %arrayidx, align 4, !dbg !26, !tbaa !27
  store i8* %unclean_stack_ptr, i8** @__cleanstack_unclean_stack_ptr, !dbg !31
  ret i32 %2, !dbg !31
}
...
attributes #0 = { norecurse nounwind readonly cleanstack uwtable "disable-tail-calls"="false" "less-precise-fpmad"="false" "frame-pointer"="none" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+fxsr,+mmx,+sse,+sse2" "unsafe-fp-math"="false" "use-soft-float"="false" }
