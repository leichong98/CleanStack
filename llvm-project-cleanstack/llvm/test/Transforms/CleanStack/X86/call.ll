; RUN: opt -clean-stack -S -mtriple=i386-pc-linux-gnu < %s -o - | FileCheck %s
; RUN: opt -clean-stack -S -mtriple=x86_64-pc-linux-gnu < %s -o - | FileCheck %s
...
define void @foo(i8* %a) nounwind uwtable cleanstack {
entry:
  ; CHECK-LABEL: define void @foo(
  ; CHECK-NOT: __cleanstack_unclean_stack_ptr
  ; CHECK: ret void
...
define void @call_memset(i64 %len) cleanstack {
entry:
  ; CHECK-LABEL: define void @call_memset
  ; CHECK: @__cleanstack_unclean_stack_ptr
  ; CHECK: ret void
...
define void @call_constant_memset() cleanstack {
entry:
...
define void @call_constant_overflow_memset() cleanstack {
entry:
...
define void @call_constant_underflow_memset() cleanstack {
entry:
...
; Readnone nocapture -> clean
define void @call_readnone(i64 %len) cleanstack {
entry:
...
define void @call_readnone0_0(i64 %len) cleanstack {
entry:
...
; Arg0 is readnone, arg1 is not. Pass alloca ptr as arg1 -> unclean
define void @call_readnone0_1(i64 %len) cleanstack {
entry:
...
; Readonly nocapture -> unclean
define void @call_readonly(i64 %len) cleanstack {
entry:
...
; Readonly nocapture -> unclean
define void @call_arg_readonly(i64 %len) cleanstack {
entry:
...
; Readwrite nocapture -> unclean
define void @call_readwrite(i64 %len) cleanstack {
entry:
...
; Captures the argument -> unclean
define void @call_capture(i64 %len) cleanstack {
entry:
...
; Lifetime intrinsics are always clean.
